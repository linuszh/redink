...
Partial Class Ribbon1
    ...
    "e 2nd configured model, if available"
        ...
        Me.Menu2.Items.Add(Me.RI_RIRemove)
        ...
        'RI_RIRemove
        '
        Me.RI_RIRemove.Label = "Remove RI: Reference"
        Me.RI_RIRemove.Name = "RI_RIRemove"
        Me.RI_RIRemove.OfficeImageId = "ReviewDeleteComment"
        Me.RI_RIRemove.ScreenTip = "Remove the 'RI:' from comments indicating that they have been generated by Red In" &
    "k"
        Me.RI_RIRemove.ShowImage = True
        '
        'RI_Chat
        '
