...
Partial Public Class ThisAddIn
    ...
    Public Async Function RunIsolatedToolingLoopAsync(
        ...
        Try
            ...
            ToolingFileLogger.LogStep($"[subagent-host] host=Word; agent='{request.AgentName}'; allowed_tools={If(request.AllowedToolNames Is Nothing, "(default-host-scope)", If(request.AllowedToolNames.Count = 0, "(none)", String.Join(", ", request.AllowedToolNames)))}")
            ToolingFileLogger.LogStep("[subagent-host] sequencing=shared_tool_call_sequencing")

            ' Replace the registry/preflight block inside RunIsolatedToolingLoopAsync(...)
